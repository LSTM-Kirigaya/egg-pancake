...
class State(object):
    ...
    @property
    def greaterPos(self):
        return self._greaterPos
    @property
    def greaterAction(self):
        return self._greaterAction
    @property
    def handCards(self):
        return self._handCards
    @property
    def oppoRank(self):
        return self._oppoRank
    @property
    def curRank(self):
    ...
    @property
    def antiNum(self):
        return self._antiNum
    @property
    def antiPos(self):
        return self._antiPos
    @property
    def result(self):
        return self._result
    @property
    ...
    def settingTimes(self):
        return self._settingTimes
    @property
    def victoryNum(self):
        return self._victoryNum
    @property
    def draws(self):
        return self._draws
    @property
    def restCards(self):
        return self._restCards
